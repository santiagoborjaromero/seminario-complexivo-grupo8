...
from dashboard.funciones import load_data, get_dynamic_columns, api
...
# # API_URL_DATOS_KNN = f"{API_BASE_URL}/recomnedation/colaborativa/"
# # BASE_DIR = os.getcwd() 
...
# # def main():
# #     print("asdasdasd")
# #     # # df_procesado = api(API_URL_DATOS_KNN)
